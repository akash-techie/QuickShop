...
<div id="latest-post">
           ...
           <% Enumeration enumeration = ch.elements();
	    	...
	    	<%}%> 
            <tr><td colspan=3><div align="center"><input type="button" value="Add New" onclick="javascript:location.href='AddStock.jsp'" style="border-radius:12px;width:40%;"/></div></td>
            <td colspan=2><div align="center"><input type="submit" value="Delete" name="delete" style="border-radius:12px;width:40%;"/></div></td></tr>
           </table>
           <%}%>
           </fieldset>
                  </form>
