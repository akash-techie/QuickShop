					...
					<TD>
						<TABLE border="0" align="center">
							...
							<TR>
								<TD align="right"></TD>
								<TD>
									<TABLE border="0" align="center" cellpadding="10" style="text-align:left;padding-left:80px;">
										<TR>
											<TD colspan=2>
												Login Name
											</TD>
										...
										<TR>
											<TD colspan="2">
												<DIV align="center">
													<INPUT name="Input" type="submit" value="Recover" onclick="return validate()" style="border-radius:12px;width:100%;"/>
											 </td> <td> <INPUT name="Input" type="reset" value="Clear" style="border-radius:12px;width:40%;"/>
												</td></DIV>
